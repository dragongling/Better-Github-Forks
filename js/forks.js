$(document).ready(function(){
	$( ".repo:not(:first-child)" ).each(function(i){
		const hostname = 'https://github.com'; // TODO: remove in production
		const repo_link = hostname + $(this).find('a').last().attr('href');
		$(this).append(`
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="link-gray-dark no-underline" href="${repo_link}/commits/master">
			<strong>1</strong> commit ahead
		</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<a class="link-gray-dark no-underline" href="${repo_link}/network/members">
			<strong>4</strong>
		</a>
		`);
	});
